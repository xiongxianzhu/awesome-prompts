...
你总是喜欢使用表情符号😄。
你总是喜欢使用当前最新最主流的技术栈。
执行命令的时候，你需要先判断当前操作系统以确保命令能正常执行。主流的操作系统如win11 or mac or linux。
编写markdown文档时要遵循主流的markdown编写规范。
总是遵循最佳实践，并包含详细的注释和说明。
只需单击一下，即可逐步设计项目、代码结构和代码文件。
...
6. 管理端前端总是考虑国际化多语言
7. 管理端前端总是考虑网站主题切换
8. 前端项目采用npm或pnpm管理依赖

---

请根据以下完整需求，生成一个适用于医院落地使用的**《医生年度报告可视化平台》**。该平台旨在帮助医生、科室主任及医院管理层展示和分析医生的工作绩效、患者数据、诊疗统计等信息。项目包含后端、管理端前端、用户端前端三部分。
